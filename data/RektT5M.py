...
# CHANGELOG
#
# 25.05.2011 - 1.2ao - NTAuthority
#   * remove parser stuff
# 3.05.2019 -- 1.4 -- Fry
#   * rename RIP.v2ops to RektT5M
#

## @file
#  CoD7 Parser

# Edited to be compatible with the V2Ops client Version 1

__author__  = 'Fry, Freelander, Courgette, Just a baka, Bravo17, NTAuthority'
__version__ = '1.4'
...
class RektT5MParser(b3.parsers.cod5.Cod5Parser):
    gameName = 'RektT5M' #Renamed from v2ops and alterops to not cause conflicts with original parsers
    IpsOnly = False
    _guidLength = 1

    _usePreMatchLogic = False
    _preMatch = False
    _elFound = True
    _igBlockFound = False
    _sgFound = False
